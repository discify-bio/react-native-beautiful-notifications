...
const Provider = ({ children, config }) => {
    ...
    const closeModal = () => {
        value.value = (0, react_native_reanimated_1.withTiming)(0, {
            duration: 350
        }, () => (0, react_native_worklets_1.scheduleOnRN)(clear));
    };
    const onPress = () => {
        closeModal();
    ...
    const startTimeout = () => {
        ...
        setTimeoutNumber(setTimeout(() => {
            closeModal();
        }, (_a = config === null || config === void 0 ? void 0 : config.duration) !== null && _a !== void 0 ? _a : 3500));
    };
    const gesture = react_native_gesture_handler_1.Gesture.Pan()
        ...
        'worklet';
        if (timeoutNumber !== null)
            (0, react_native_worklets_1.scheduleOnRN)(stopTimeout);
    })
        .onUpdate(event => {
        'worklet';
        ...
        if (event.translationY > -10) {
            (0, react_native_worklets_1.scheduleOnRN)(startTimeout);
        ...
        (0, react_native_worklets_1.scheduleOnRN)(closeModal);
    });
    ...
    return (react_1.default.createElement(Context_1.default.Provider, { value: ref },
        react_1.default.createElement(react_native_portalize_1.Host, { style: {
            ...
            react_1.default.createElement(react_native_portalize_1.Portal, null, isOpen && (react_1.default.createElement(react_native_gesture_handler_1.GestureDetector, { gesture: gesture },
                react_1.default.createElement(react_native_1.TouchableOpacity, { activeOpacity: (_a = config === null || config === void 0 ? void 0 : config.activeOpacity) !== null && _a !== void 0 ? _a : 0.7, onPress: onPress },
