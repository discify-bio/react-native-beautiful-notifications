...
const Provider = ({ children }) => {
    ...
    const translateValue = react_native_reanimated_1.useSharedValue(0);
    ...
    const gesture = react_native_gesture_handler_1.Gesture.Pan()
        .activeOffsetY([-10, 0])
        .onUpdate(event => {
        const value = event.translationY / 2;
        if (value > 0)
            return;
        ...
        if (event.translationY > -10) {
            translateValue.value = react_native_reanimated_1.withSpring(0, {
                stiffness: 250,
                damping: 25
            });
            return;
    ...
    const blockStyle = react_native_reanimated_1.useAnimatedStyle(() => {
        return {
            transform: [
                {
    ...
    return (react_1.default.createElement(Context_1.default.Provider, { value: ref },
        react_1.default.createElement(react_native_portalize_1.Host, { style: {
            ...
            react_1.default.createElement(react_native_portalize_1.Portal, null,
                react_1.default.createElement(react_native_safe_area_context_1.SafeAreaView, null, isOpen && (react_1.default.createElement(react_native_gesture_handler_1.GestureDetector, { gesture: gesture },
                    react_1.default.createElement(react_native_reanimated_1.default.View, { key: id, entering: react_native_reanimated_1.FadeInUp, exiting: react_native_reanimated_1.FadeOutUp, style: blockStyle }, notificationChildren))))),
            children)));
};
